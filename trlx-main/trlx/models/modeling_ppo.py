...
class AutoModelForCausalLMWithHydraValueHead(AutoModelForCausalLMWithValueHead):
    ...
    def forward_hydra(
        ...
        input_ids = forward_kwargs.pop("input_ids", None)  # Ignore `input_ids` for branch head
        # forward_kwargs.pop("position_ids", None)  # Ignore `input_ids` for branch head
        ...
        # forward_kwargs.pop("attention_mask", None)  # Ignore `inputs_embeds` for branch head
...
def hf_get_branch_class(
    ...
    chatglm_branch_supported_archs = ["ChatGLMModel", "ChatGLMForConditionalGeneration"]
    ...
    if arch in gpt_branch_supported_archs:
    ...
    elif arch in chatglm_branch_supported_archs:
        ...
        all_supported_archs = sum(
            [
                ...
                chatglm_branch_supported_archs,
            ],
            [],
        )
        raise ValueError(
